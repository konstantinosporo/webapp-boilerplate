...
function ProfileMenu() {
  return (
    <Menu>
      ...
      <Menu.Content>
        <Menu.Item>
          <UserCircle className="mr-2 h-[18px] w-[18px]" />
        ...
        <Menu.Item>
          <HeadsetHelp className="mr-2 h-[18px] w-[18px]" />
...
// Define ComplexNavbar Component
